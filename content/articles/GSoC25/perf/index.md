...
<p>There's other <code>-e</code> options you can try, Read lu_zeros' article. {{< footnote "lu_zero's article" " https://dev.to/luzero/bringing-up-bpi-f3-part-25-27o4" >}}</p>
