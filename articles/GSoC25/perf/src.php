...
?<p>Cross compile fails, so just build it on your board. It took around 10mins on Milk-V jupiter.</p>

<?php h("How to run perf"); ?>
<pre><code>
sudo perf record -e u_mode_cycle ls
sudo perf report # You might not need a root permission</code></pre>
